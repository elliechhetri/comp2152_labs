...
while not input_valid and i in range(5):
    ...
    # Question 1: Add try and exception blocks
    try:
        ...
        print("Invalid input. Please use integer values.")
...
while not m_input_valid and i in range(5):
    ...
    # Question 2, Part 1: Add try and exception blocks
    try:
...
# Question 2, Part 2: Add try and exception blocks for monster health points when the hero attacks
try:
    m_health_points = function.hero_attacks("Something 1", "Something 2")
